"""Repository for Polygon PoS chain data."""
import logging
...
class PolygonRepository:
    """
    Repository for Polygon PoS-specific database operations.
    
    Handles all database interactions for Polygon chain data including:
    ...
    def __init__(self, session: AsyncSession) -> None:
        ...
        self.chain_id = 137  # Polygon PoS chain ID
