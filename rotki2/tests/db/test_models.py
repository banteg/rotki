...
from rotki2.db.models.globaldb import Base as GlobalBase
from rotki2.db.models.transient import Base as TransientBase
from rotki2.db.models.user import Base as UserBase
