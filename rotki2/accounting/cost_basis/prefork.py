"""Prefork asset handling for cost basis calculations"""
...
if TYPE_CHECKING:
    from .calculator import CostBasisCalculator
...
async def handle_prefork_asset_spends(
    ...
    if asset == A_ETH and timestamp < ETH_DAO_FORK_TS:
        await cost_basis.reduce_asset_amount(
