...
from rotkehlchen.db.orm.session import get_session_manager
...
class MigrationStep:
    ...
    verify_func: Optional[Callable[[Session, Session], bool]] = None
    rollback_func: Optional[Callable[[Session, Session], None]] = None
