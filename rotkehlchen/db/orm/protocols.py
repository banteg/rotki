...
class GnosisPayData(Base):
    ...
    merchant_city: Mapped[str | None] = mapped_column(TEXT)
    ...
    billing_symbol: Mapped[str | None] = mapped_column(TEXT)
    billing_amount: Mapped[str | None] = mapped_column(FValType)
    reversal_symbol: Mapped[str | None] = mapped_column(TEXT)
    reversal_amount: Mapped[str | None] = mapped_column(FValType)
    reversal_tx_hash: Mapped[bytes | None] = mapped_column(HexBytesType, unique=True)
