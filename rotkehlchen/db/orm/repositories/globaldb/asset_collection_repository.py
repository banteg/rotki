...
class AssetCollectionRepository(BaseRepository[AssetCollection]):
    ...
    def get_collection(self, collection_id: int) -> AssetCollection | None:
        """Get a collection by ID"""
        return self.get(id=collection_id)

    def get_collection_by_name(self, name: str) -> AssetCollection | None:
        """Get a collection by name"""
        return self.get(name=name)

    def get_collection_by_symbol(self, symbol: str) -> AssetCollection | None:
