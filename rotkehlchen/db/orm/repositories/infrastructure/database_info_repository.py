...
class DatabaseInfoRepository(BaseRepository[DBInfo]):
    ...
    def get_last_write_timestamp(self) -> Optional[int]:
    ...
    def get_last_data_migration(self) -> Optional[int]:
    ...
    def get_last_owned_assets_update(self) -> Optional[int]:
    ...
    def get_info(self) -> Optional[DBInfo]:
    ...
    def _get_info(self) -> Optional[DBInfo]:
    ...
    def update_info(
        ...
        last_data_migration: Optional[int] = None,
        last_owned_assets_update: Optional[int] = None,
    ) -> DBInfo:
