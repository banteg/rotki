...
class PremiumRepository(BaseRepository[PremiumCredential]):
    ...
    def get_credentials(self) -> Optional[PremiumCredential]:
    ...
    def get_sync_record(self, data_type: str) -> Optional[PremiumSync]:
    ...
    def get_last_sync_timestamp(self, data_type: str) -> Optional[Timestamp]:
