...
class ETH2ValidatorRepository(BaseRepository[ETH2Validator]):
    ...
    def get_validator(self, validator_index: int) -> Optional[ETH2Validator]:
        """Get a validator by index"""
        return self.get(validator_index=validator_index)
    
    def get_validator_by_public_key(self, public_key: str) -> Optional[ETH2Validator]:
