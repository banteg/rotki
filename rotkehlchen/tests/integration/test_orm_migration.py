...
from rotkehlchen.api.rest_orm import RestAPI
from rotkehlchen.assets.asset import Asset
from rotkehlchen.balances.manual_orm import add_manually_tracked_balances, get_manually_tracked_balances
...
from rotkehlchen.data_import.manager_orm import CSVDataImporter, DataImportSource
...
from rotkehlchen.history.manager_orm import HistoryQueryingManager
from rotkehlchen.premium.sync_orm import PremiumSyncManager
...
class TestExchangeManagement:
    ...
    def test_exchange_operations(self, orm_database):
        ...
        # Setup exchange
        success, msg = manager.setup_exchange(
            name='test_binance',
...
class TestDataImportExport:
    ...
    def test_csv_export(self, orm_database, temp_data_dir):
        ...
        success, msg = importer.export_data(export_dir)
...
class TestAccountingWithORM:
    ...
    def test_report_management(self, orm_database):
        ...
        # Create a report
        with db.repos.unit_of_work():
            report_id = db.repos.accounting_reports.create_report(
                report_id=1,
